...
class QuizzController {
    ...
    public function highlightGoodAnswer($goodAnswer, $radioValue) {
        $style = 'border: solid 3px; padding: 3px; width: 25px; color: #00cc00; border-style: dotted;';
        return $style = $radioValue == $goodAnswer ? $style : '';
    }

    public function highlightUserChoice($userPostedDatas, $radioValue, $i) {
        $userSelectedChoices = [];
        $style = 'border: solid 3px; padding: 3px; width: 25px; color: red; border-style: dotted;';
